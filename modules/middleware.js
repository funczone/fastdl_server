...
import { httpCodeSeverity } from "./util.js";
import { errorResponse } from "./responses.js";

/** 404 handling middleware. @see https://tinyhttp.v1rtl.site/docs#nomatchhandlerreq-res */
export const noMatchHandler = (req, res) => {
    ...
    if (req.accepts("html")) {
        ...
        return res.render("template.eta", {
            title: "404 Not Found",
            // icon: "",
            // style: "/css/404.css",
            partial: "./pages/404.eta",
            url: req.url,
        });
...
/** Error handling middleware. @see https://tinyhttp.v1rtl.site/docs#onerrorerr-req-res */
